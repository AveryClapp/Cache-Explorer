...
std::vector<OptimizationSuggestion>
OptimizationSuggester::analyze(const std::vector<FalseSharingReport> &false_sharing,
...
std::vector<OptimizationSuggestion>
OptimizationSuggester::analyze(const std::vector<SourceStats> &hot_lines,
